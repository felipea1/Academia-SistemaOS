...
public class Servicos extends JDialog {
	...
	public Servicos() {
		...
		lblNewLabel.setIcon(new ImageIcon(Servicos.class.getResource("/img/128x128 god of gym.png")));
				...
				try {
					...
					if (rs.next()) {
						...
						Paragraph telebairro = new Paragraph(
								"Telefone:         _____________________                   Endereço: _________________________");
						...
						Image imagem = Image.getInstance(Servicos.class.getResource("/img/128x128 god of gym.png"));
